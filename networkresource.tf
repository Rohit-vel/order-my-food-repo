...
resource "aws_route_table_association" "pub-route-1-association" {
  route_table_id = aws_route_table.public-route-table.id
  subnet_id      = aws_subnet.public-sub-1.id
}
resource "aws_route_table_association" "pub-route-2-association" {
  route_table_id = aws_route_table.public-route-table.id
  subnet_id      = aws_subnet.public-sub-2.id
}
resource "aws_route_table_association" "pub-route-3-association" {
  route_table_id = aws_route_table.public-route-table.id
