...
// mongoose.connect(db1:12345678@demo2.cluster-cnkzcsnwzaov.ap-south-1.docdb.amazonaws.com:27017/?ssl=true&ssl_ca_certs=rds-combined-ca-bundle.pem&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false)
//   .then(() => {
//     console.log("Connected to the database successfully");
//   })
//   .catch(err => console.log(err,"psst"));


  mongoose.connect('mongodb+srv://db:12345@db.orkf58y.mongodb.net/?retryWrites=true&w=majority', {
